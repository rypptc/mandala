...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='CollaboratorRequestFormField',
            fields=[
                ...
                ('page', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='form_fields', to='roles.collaboratorrequestpage')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
